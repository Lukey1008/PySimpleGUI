...
layout = [
    [sg.Text('Website Opener', 
             size=(18,1), 
             font = 'Calibri 30', 
             justification='c', 
             background_color='#2f2c30', 
             text_color='white')],
    ...
    [sg.Checkbox('Google', 
                 ...
                 text_color='white', 
                 size=(8,1)), 
     sg.Checkbox('Edge Hill Blackboard', 
                 key = '-EHU_BB-', 
                 font = 'Calibri 15', 
                 background_color='orange', 
                 text_color='white')],

    [sg.Button('Open Selected',
               expand_x=True, 
               expand_y= True, 
               font = 'Calibri 18', 
               button_color='#2f2c30')],
